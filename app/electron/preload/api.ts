...
export const api = {
  ...
  sales: {
    ...
    suspend: (payload: unknown) => ipcRenderer.invoke('sales:suspend', payload),
    listSuspended: (payload: unknown) => ipcRenderer.invoke('sales:suspended-list', payload),
    getSuspended: (payload: unknown) => ipcRenderer.invoke('sales:suspended-get', payload),
    deleteSuspended: (payload: unknown) => ipcRenderer.invoke('sales:suspended-delete', payload),
    listRecent: (payload: unknown) => ipcRenderer.invoke('sales:recent', payload),
    getDetail: (payload: unknown) => ipcRenderer.invoke('sales:detail', payload),
  ...
  users: {
    ...
    changePassword: (payload: unknown) => ipcRenderer.invoke('users:change-password', payload),
  },
